...
def check_strategy(filename = "mensagens.txt"):
  ...
  percentage_reds = calculate_percentage(count_reds, count_reds + count_greens)
  ...
  # print(f"Percentage Reds: {percentage_reds}%")
  print(f"Percentage Greens: {percentage_greens}%")
  
  print('\n')
  percentage_greens_after_red = calculate_percentage(count_greens_after_red, count_greens_after_red + count_red_after_one_red)
  percentage_red_after_one_red = calculate_percentage(count_red_after_one_red, count_greens_after_red + count_red_after_one_red)
  ...
  # print(f"Percentage Reds after one red: {percentage_red_after_one_red}%")
